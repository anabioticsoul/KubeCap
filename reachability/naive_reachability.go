...
type Flags struct {
	...
	excludeMain        bool
	excludeInit        bool
	suppressLoadErrors bool
	suppressLoaderLogs bool
}
...
func NewFlags(args []string) (Flags, error) {
	...
	suppressLoadErrors := flags.FlagSet.Bool("suppress-load-errors", false, "suppress printing package load/type errors")
	suppressLoaderLogs := flags.FlagSet.Bool("quiet-loader", false, "suppress loader progress logs")
	...
	return Flags{
		...
		excludeMain:        *noMain,
		excludeInit:        *noInit,
		suppressLoadErrors: *suppressLoadErrors,
		suppressLoaderLogs: *suppressLoaderLogs,
	}, nil
}
...
func Run(flags Flags, manager *analysis.AnalysisManager) error {
	var err error
	...
	loadOptions := config.LoadOptions{
		...
		ApplyRewrites:      false,
		SuppressLoadErrors: flags.suppressLoadErrors,
	}
	...
	reachability.ReachableFunctionsAnalysis(manager, state, flags.excludeMain, flags.excludeInit, flags.outputJson)
